...
const ContractorServiceCategory: React.FC = () => {
  const { category } = useParams<{ category: string }>();
  
  const service = contractorServices.find(
            ...
            <Card className="mb-6">
              ...
              <CardContent>
                <ul className="list-disc list-inside text-muted-foreground">
                  {service.industryStandards.map((standard, index) => (
...
export default ContractorServiceCategory;
